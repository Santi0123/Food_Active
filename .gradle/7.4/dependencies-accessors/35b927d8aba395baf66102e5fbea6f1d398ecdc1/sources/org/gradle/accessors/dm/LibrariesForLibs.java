...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class PlayServicesLibraryAccessors extends SubDependencyFactory {
         ...
         */
        public PlayServicesMlkitLibraryAccessors getMlkit() { return laccForPlayServicesMlkitLibraryAccessors; }
    ...
    public static class PlayServicesMlkitLibraryAccessors extends SubDependencyFactory {
         ...
         */
        public PlayServicesMlkitTextLibraryAccessors getText() { return laccForPlayServicesMlkitTextLibraryAccessors; }
    ...
    public static class PlayServicesMlkitTextLibraryAccessors extends SubDependencyFactory {
         ...
         */
        public PlayServicesMlkitTextRecognitionLibraryAccessors getRecognition() { return laccForPlayServicesMlkitTextRecognitionLibraryAccessors; }
    ...
    public static class PlayServicesMlkitTextRecognitionLibraryAccessors extends SubDependencyFactory {
        ...
        public PlayServicesMlkitTextRecognitionLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getCommon() { return create("play.services.mlkit.text.recognition.common"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: activityKtx (1.10.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: navigationFragmentKtx (2.8.4)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: navigationUiKtx (2.8.4)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: playServicesMlkitTextRecognitionCommon (19.1.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
